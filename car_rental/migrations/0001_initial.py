    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("birth_date", models.DateField(default=datetime.date(2024, 3, 25))),
                ("driving_license_number", models.CharField(max_length=100)),
                ("issue_date", models.DateField(default=datetime.date(2024, 3, 25))),
                ("expiry_date", models.DateField(default=datetime.date(2024, 3, 25))),
                (
                    "customer",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
